...
<style type="text/css">
body {background-image:url("image/bck.png");background-repeat:no-repeat;background-attachment:fixed;
...
<body>
  <header >
    <div class="head">
      <img src="image/cc.png" width="80" height="80">
      <h1>WAYA<br>
      Attendance System</h1>
    </div>
    <a href="..\weekday.html">Attendance Logger</a>
  </header>
...
<img src="" style="float: right;width:200px;right:2%;top:125px;position: absolute;">
<a href=""><img src="" style="float: right;right:8%;top:325px;position: absolute;"></a>
