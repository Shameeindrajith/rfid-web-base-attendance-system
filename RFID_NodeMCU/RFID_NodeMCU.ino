...
const char *ssid = "Dialog 4G 692";  //ENTER YOUR WIFI SETTINGS
const char *password = "409671d1";

//Web/Server address to read/write from 
const char *host = "192.168.8.187";   //IP address of server
...
void loop() {
 ...
 for (byte i = 0; i < mfrc522.uid.size; i++) {
  ...
  Link = "http://192.168.8.187/loginsystem/postdemo.php" + getData;
